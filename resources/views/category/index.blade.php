                ...
                <div class="m-portlet m-portlet--mobile">
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <a href="{{route('category.create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
                                        <span>
                    ...
                    <div class="m-portlet__body">
                     ...
                     <i class="fa-check-circle"></i> </a>
                            @else
 <a href="{{ route('category.show',$category->id ) }}" class="btn btn-danger" > <i class="fa-check-circle"></i></a>
                                          @endif
                                      </td>
                    <td >

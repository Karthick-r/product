            ...
            <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                <div class="tab-content">
                    <div class="tab-pane active" id="m_user_profile_tab_1">
                        <form class="m-form m-form--fit m-form--label-align-right" action="{{ route ('district.update', $district->id ) }}" method="POST">
                                                ...
                                                <label for="example-text-input" class="col-2 col-form-label text-left"> Select Zone</label>
                                                       <div class="col-4">
                                                               <select class="form-control m-input"  id="zone" name="zone"  >
                                                                    ...
                                                                    @if($zone->id== $district->zone_id)
                                                                    <option value="{{$zone->id}}" @if($zone->id== $district->zone_id) {{'selected'}}@endif>{{$zone->name}}</option>
                            ...
                            <div class="form-group m-form__group row   @if ($errors->has('name')) {{'has-danger'}} @endif">
                                    ...
                                    <div class="col-4">
                                        <input class="form-control m-input" name="name" type="text" value="{{ $district->name }}" >
                                        @if ($errors->has('name'))

...
<script class="jsbin" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.0/jquery-ui.min.js"></script>
		...
		<script src="{{asset('assets/demo/custom/crud/forms/validation/form-controls.js')}}" type="text/javascript"></script>
		...
		<script src="{{asset('assets/demo/custom/crud/datatables/basic/scrollable.js')}}" type="text/javascript"></script>

                    ...
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <a href="{{route('product_category.create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
                                        <span>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            @if($product_category->status==1)                                   
                                  <a href="{{ route('product_category.show',$product_category->id ) }}" class="btn btn-success">
                     <i class="fa-check-circle"></i> </a>
                            @else
 <a href="{{ route('product_category.show',$product_category->id ) }}" class="btn btn-danger" > <i class="fa-check-circle"></i></a>
                                          @endif
                                      </td>
                    <td >

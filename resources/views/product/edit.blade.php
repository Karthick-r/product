            ...
            <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                <div class="tab-content">
                    <div class="tab-pane active" id="m_user_profile_tab_1">
                        <form class="m-form m-form--fit m-form--label-align-right" action="{{ route ('products.update', $product->id ) }}" method="POST">
                            ...
                            <div class="form-group m-form__group row   @if ($errors->has('name')) {{'has-danger'}} @endif">
                                    ...
                                    <div class="col-4">
                                        <input class="form-control m-input" name="name" type="text" value="{{ $product->name }}" >
                                        @if ($errors->has('name'))
